export default class Player2 {
    constructor(ctx, W, H, HH, HW) {
        ...
        this.Right.src = '../../imgs/p2right.png'; // Sprite para o Player 1 quando se move para a direita
        this.Left = new Image();
        this.Left.src = '../../imgs/p2left.png'; // Sprite para o Player 1 quando se move para a esquerda
