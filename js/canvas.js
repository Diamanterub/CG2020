export default class GameCanvas{
    constructor() {
        ...
        let rightKey = false; let leftKey = false; let letterDKey = false; let letterAKey = false;
        ...
        let P1RightMove = true; let P2RightMove = true; // Por default, os players estão virados para o lado direito,
        let P1LeftMove = false; let P2LeftMove = false; let P1Harpoon = false; let P2Harpoon = false; // mas estas variáveis servem para detetar e efetuar determinado drawImage.
